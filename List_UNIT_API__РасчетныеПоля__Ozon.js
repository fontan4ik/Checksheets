...
function resumeOzonReport65PerformanceCore_() {
...
function resumeOzonReport65Performance() {
  var args = arguments;
  return runWithTelegramAlertGAS_('resumeOzonReport65Performance', function() {
    return resumeOzonReport65PerformanceCore_.apply(null, args);
  });
}
