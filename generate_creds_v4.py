...
# This key is copied directly from the user's first message block.
# I will use a list of lines and then join them with actual newlines.
key_lines = [
    "-----BEGIN PRIVATE KEY-----",
...
print("gsheets_creds.json has been generated correctly from individual lines.")
