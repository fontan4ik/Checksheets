...
ws = ss.worksheet("ТЗ")
formula = r'''={"TEST";MAP(A2:A;LAMBDA(a;IF(a="";"";IFERROR(SUM(FILTER(ARRAYFORMULA(IFERROR(VALUE(SUBSTITUTE(PPO!P3:P;" ";""));0));REGEXREPLACE(SUBSTITUTE(UPPER(TO_TEXT(PPO!Q3:Q));"Ё";"Е");"[^0-9A-ZА-Я]";"")=REGEXREPLACE(SUBSTITUTE(UPPER(REGEXREPLACE(TO_TEXT(a);"-[0-9]+$";""));"Ё";"Е");"[^0-9A-ZА-Я]";"")));0))))}'''
