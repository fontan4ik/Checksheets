...
// Конфигурация Huckster для этого Apps Script-проекта.
 ...
 */
function updateHucksterPricesCore_() {
...
function updateHucksterPrices() {
  var args = arguments;
  return runWithTelegramAlertGAS_('updateHucksterPrices', function() {
    return updateHucksterPricesCore_.apply(null, args);
  });
}
