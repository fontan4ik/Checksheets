...
# Using raw string for the private key to ensure backslashes are preserved as literals
...
creds = {
  ...
  "private_key": private_key.replace("\\n", "\n"), # Convert backslash-n to real newlines for json.dump
...
print("SUCCESS: Rewrote gsheets_creds.json using proper json.dump")
