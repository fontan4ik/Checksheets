...
function updateYearlySales() {
  ...
  sheet.getRange(2, columnByHeader_(sheet, "Количество продаж Год ОЗОН"), ozonValues.length, 1).setValues(ozonValues);
  sheet.getRange(2, columnByHeader_(sheet, "Количество продаж Год ВБ"), wbValues.length, 1).setValues(wbValues);
