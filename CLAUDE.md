...
2. Provide upload instructions following this format when delivering changes:
    ```text
...
| **по заголовку** | — | СПП X (Huckster `market_card_discount`) | `updateHucksterPrices()` in `Huckster цены.js` | ✅ |
