...
function updateOzonStorageCost() {
  return runWithTelegramAlertGAS_("updateOzonStorageCost", updateOzonStorageCostCore_);
}

function updateOzonStorageCostCore_() {
  ...
  const storageColumn = columnByHeader_(sheet, "Хранение");
  ...
  sheet.getRange(2, storageColumn, valuesToWrite.length, 1).setValues(valuesToWrite);
