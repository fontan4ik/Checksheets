...
function updateOzonAdExpenses() {
  ...
  sheet.getRange(2, columnByHeader_(sheet, "Расход по рекламе по ску"), colAU.length, 1).setValues(colAU);
...
function step2_CollectReports() {
  return runWithTelegramAlertGAS_("step2_CollectReports", step2_CollectReportsCore_);
}

function step2_CollectReportsCore_() {
  Logger.log("============================================");
