...
function resumeOzonReportQuarterFinanceCore_() {
...
function resumeOzonReportQuarterStorageCore_() {
...
function resumeOzonReportQuarterPerformanceCore_() {
...
function resumeOzonReportQuarterFinance() {
  var args = arguments;
  return runWithTelegramAlertGAS_('resumeOzonReportQuarterFinance', function() {
    return resumeOzonReportQuarterFinanceCore_.apply(null, args);
  });
}

function resumeOzonReportQuarterStorage() {
  var args = arguments;
  return runWithTelegramAlertGAS_('resumeOzonReportQuarterStorage', function() {
    return resumeOzonReportQuarterStorageCore_.apply(null, args);
  });
}

function resumeOzonReportQuarterPerformance() {
  var args = arguments;
  return runWithTelegramAlertGAS_('resumeOzonReportQuarterPerformance', function() {
    return resumeOzonReportQuarterPerformanceCore_.apply(null, args);
  });
}
