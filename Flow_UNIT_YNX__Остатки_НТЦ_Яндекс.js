 ...
 */
function syncOzonNtcStocksToUnitYnxCore_() {
 ...
 * В Яндекс загружаются все строки с непустым offer_id из колонки A.
 * Ozon и Google Sheets не обновляет: в Яндекс уходят только значения из найденной колонки.
 */
function syncUnitYnxNtcStocksToYandexCore_() {
...
function syncOzonNtcStocksToUnitYnx() {
  var args = arguments;
  return runWithTelegramAlertGAS_('syncOzonNtcStocksToUnitYnx', function() {
    return syncOzonNtcStocksToUnitYnxCore_.apply(null, args);
  });
}

function syncUnitYnxNtcStocksToYandex() {
  var args = arguments;
  return runWithTelegramAlertGAS_('syncUnitYnxNtcStocksToYandex', function() {
    return syncUnitYnxNtcStocksToYandexCore_.apply(null, args);
  });
}
