...
# Correct reconstruction using the EXACT base64 string provided in your file, 
# but ensuring it's formatted exactly as PEM expects.
...
print("google_credentials.json has been reconstructed with strict PEM formatting.")
