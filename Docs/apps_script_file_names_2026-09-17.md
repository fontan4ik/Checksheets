...
| `Зануление RS OZON.js` | `Flow_StreamSupps__Обнуление_RS_Ozon.js` |
...
| `Синхронизация остатков ARL.js` | `Flow_ARL_TR__Остатки_Маркетплейсы.js` |
| `Синхронизация остатков Ozon НТЦ в Яндекс.js` | `Flow_UNIT_YNX__Остатки_НТЦ_Яндекс.js` |
| `Синхронизация остатков RS.js` | `Flow_StreamSupps__Остатки_RS_Маркетплейсы.js` |
