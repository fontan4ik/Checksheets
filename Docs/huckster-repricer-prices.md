...
- Логин и пароль не выводятся в лог. Для текущего Apps Script-проекта конфигурация Huckster задана в `Huckster цены.js` по запросу владельца; при пустых значениях используется резервный вариант Script Properties.
