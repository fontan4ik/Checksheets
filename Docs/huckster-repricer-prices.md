...
- В начале `Huckster цены.js` есть пустые поля `HUCKSTER_USER_NAME` и `HUCKSTER_PASSWORD`; их можно заполнить вручную. Если оставить их пустыми, используются Script Properties с такими же ключами.
